...
score_train = tree_clf_gini.score(X_train, y_train); # Goodness of tree on training dataset
...
plot_tree(tree_clf_gini, feature_names = input_names, 
...
score_entropy = tree_clf_entropy.score(X_train, y_train); # Goodness of tree on training dataset
...
plot_tree(tree_clf_entropy, feature_names = input_names, 
               class_names = target_names,
               filled = True, fontsize = 6);
# Writing to local repository as C:\\Users\user_name 
