...
neural_clf = MLPClassifier(hidden_layer_sizes=(5),activation='logistic',max_iter=500);  #  number of hidden neurons: 5
...
plt.scatter(X_test[:,x_axis],X_test[:,y_axis],s=100*proba_neural[:,1],
            c=pred_neural,cmap=col.ListedColormap(colors));
