...
)  # importing nearest neighbor classifier
...
X_train, X_test, y_train, y_test = train_test_split(
    digits.data, digits.target, test_size=0.3, shuffle=True, random_state=2024
)
...
neural_clf = MLPClassifier(
    hidden_layer_sizes=(16), activation="logistic", solver="lbfgs", max_iter=5000
